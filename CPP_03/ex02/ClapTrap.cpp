...
/*   Updated: 2025/12/10 01:46:57 by hlichten         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap& ClapTrap::operator=(const ClapTrap& other){
	...
	std::cout << "Clap Trap copy operator called for "<< _name << std::endl;
	return (*this);
}

ClapTrap::~ClapTrap(){
	std::cout << "Clap Trap destructor called for "<< _name << std::endl;
}
